...
namespace zfnav
{
    namespace spa
    {
        ...
        ZFNAV_API double deg2rad(double degrees);
        ZFNAV_API double rad2deg(double radians);
        ZFNAV_API double limit_degrees(double degrees);
        ZFNAV_API double third_order_polynomial(double a, double b, double c, double d, double x);
        ZFNAV_API double geocentric_right_ascension(double lamda, double epsilon, double beta);
        ZFNAV_API double geocentric_declination(double beta, double epsilon, double lamda);
        ZFNAV_API double observer_hour_angle(double nu, double longitude, double alpha_deg);
        ZFNAV_API void   right_ascension_parallax_and_topocentric_dec(double latitude, double elevation,
            double xi, double h, double delta, double *delta_alpha, double *delta_prime);
        ZFNAV_API double topocentric_right_ascension(double alpha_deg, double delta_alpha);
        ZFNAV_API double topocentric_local_hour_angle(double h, double delta_alpha);
        ZFNAV_API double topocentric_elevation_angle(double latitude, double delta_prime, double h_prime);
        ZFNAV_API double atmospheric_refraction_correction(double pressure, double temperature,
            double atmos_refract, double e0);
        ZFNAV_API double topocentric_elevation_angle_corrected(double e0, double delta_e);
        ZFNAV_API double topocentric_zenith_angle(double e);
        ZFNAV_API double topocentric_azimuth_angle_astro(double h_prime, double latitude, double delta_prime);
        ZFNAV_API double topocentric_azimuth_angle(double azimuth_astro);


        //Calculate SPA output values (in structure) based on input values passed in structure
        ZFNAV_API int spa_calculate(spa_data *spa);
