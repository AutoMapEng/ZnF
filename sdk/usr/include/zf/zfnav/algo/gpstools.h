#ifndef ZFNAV_GPSTOOLS_H
#define ZFNAV_GPSTOOLS_H
...
/*
        ...
        ACHTUNG   Code verschoben nach zfs/Math/nav
...
namespace navsens
{
    ...
    {
        /**
        * @brief Distance zwischen zwei Messungen
        */
        ZFNAV_API double distance(	double la1, double lo1,		// position 1
            double la2, double lo2,		// position 2
            double& dx, double& dy );	// diff x und diff y

        /**
        * @brief Grad in Sekunden in Grad in decimal umwandeln
        */
        double convert_Grad2Dec( double grad );

        /**
        *
        */
        ZFNAV_API bool WGS84( double dLatitude, double dLongitude, double& x, double& y, double& z );
        ...
        */
        ZFNAV_API void LLtoUTM(const double Lat, const double Long,
        ...
        * @param ReferenceEllipsoid the ellipsoide use for the conversion
        */
        ZFNAV_API void UTMtoLL(const double UTMNorthing, const double UTMEasting, const char* UTMZone,
        ...
        */
        ZFNAV_API double calculateGeoDistance( double la1, double lo1, double la2, double lo2, double& dx, double& dy );
        ...
        * @return the distance in meter
        */
        ZFNAV_API double calculateGeoDistanceWithUTM( double la1, double lo1, double la2, double lo2, double& dx, double& dy );
        ...
        * @return the distance in meter
        */
        ZFNAV_API double calculateGeoDistanceWithUTM( double north1, double east1, const char* zone1, double north2, double east2, const char* zone2, double& dx, double& dy );

        /**
        * @brief Funktion zur Umrechnung von geographischen in ebene,kartesische UTM-Koordinaten:
        * @deprecated Methode LLtoUTM(...) benutzen!
        */
        void ZFNAV_API geo2utm( double B_ein, double L_ein, double& E_UTM, double& N_UTM, bezugssystem_t bs=BEZUGSSYSTEM_WGS84 );

        /**
        * @brief Funktion zur Berechnung der DHHN 92 Normalh�hen H_n aus den GPS-H�hen h_ell
        */
        //double ZFNAV_API high2HighNormal( double h_ell, double U ); // ellipsoidische H�he h_ell, Undulation U

        /**
        *
        */
        double ZFNAV_API convert_grad2dec( double grad );
        ...
        * @param dop DOP Wert
        */
        ZFNAV_API dop_t parseDop( double dop );

        ZFNAV_API const char* getIconForDop(navsens::gps::dop_t dop);

        ZFNAV_API void getGPSRowString(QString& gpsString, int padding = 0);
        ...
        */
		ZFNAV_API extern Ellipsoid ellipsoid[];

		ZFNAV_API Ellipsoid* ellipsoidFindById( int id );
		ZFNAV_API Ellipsoid* ellipsoidFindByName(const char* name);
        ...
        */
        ZFNAV_API double utcstr2sec( const std::string& s );

        /**
        * @brief Helper class to store GPS Coordinates and quality values.
        */
        class ZFNAV_API GPSCoordinate {
        ...
        public:
			...
			GPSCoordinate() : latitude(0.0), longitude(0.0), altitude(0.0), satelites(0.0), hdop(100.0), vdop(100.0), hacc(0.0), vacc(0.0), age(0.0), use(true) { flags[0] = 0;  }
        ...
        */
        ZFNAV_API GPSCoordinate getGPSLimits();
        ...
        */
        ZFNAV_API void setGPSLimits(const GPSCoordinate& limitCoord);
		...
		*/
		ZFNAV_API std::wstring gpsFlags2String(const char* flags);
		...
		* @param flags typical 2 characters direct from the gps message pubx feld navstat
		*/
		ZFNAV_API bool gpsHasFix(const char* flags);

    } // end namespace
} // end namespace
#endif //ZFNAV_GPSTOOLS_H
