...
namespace zf
{
    ...
    namespace utf
    {
        ...
        ZFCORE_API const char* to_string(error err);
         ...
         */
        class ZFCORE_API unicode_error : public std::invalid_argument
        {
        public:
         ...
         */
        class ZFCORE_API encoding_error : public unicode_error
        {
        public:
         ...
         */
        class ZFCORE_API decoding_error : public unicode_error
        {
        public:
        ...
        ZFCORE_API std::u16string utf8to16(std::string_view v, char32_t repl=0);
        ZFCORE_API std::u32string utf8to32(std::string_view v, char32_t repl=0);
        ZFCORE_API std::wstring utf8_to_wstring(std::string_view v, char32_t repl=0);

        // *************************************************************************
        // convert utfx -> utf8
        // *************************************************************************

        ZFCORE_API std::string utf16to8(std::u16string_view v, char32_t repl=0);
        ZFCORE_API std::string utf32to8(std::u32string_view v, char32_t repl=0);
        ZFCORE_API std::string wstring_to_utf8(std::wstring_view v, char32_t repl=0);
         ...
         */
        ZFCORE_API std::string repair(
            std::string_view v, char32_t repl = replacement);

        /** @overload */
        ZFCORE_API std::u16string repair(
        ...
        // utf8 -> utf16
        ZFCORE_API u16string utf8to16(const char* v, char32_t repl=0);
        ZFCORE_API u16string utf8to16(const std::string& v, char32_t repl=0);

        // utf8 -> utf32
        ZFCORE_API u32string utf8to32(const char* v, char32_t repl=0);
        ZFCORE_API u32string utf8to32(const std::string& v, char32_t repl=0);

        // utf8 -> wstring (Linux: utf32; Windows: utf16)
        ZFCORE_API std::wstring utf8_to_wstring(const char* v, char32_t repl=0);
        ZFCORE_API std::wstring utf8_to_wstring(const std::string& v, char32_t repl=0);
        ...
        // utf16 -> utf8
        ZFCORE_API std::string utf16to8(const char16_t* v, char32_t repl=0);
        ZFCORE_API std::string utf16to8(const u16string& v, char32_t repl=0);

        // utf32 -> utf8
        ZFCORE_API std::string utf32to8(const char32_t* v, char32_t repl=0);
        ZFCORE_API std::string utf32to8(const u32string& v, char32_t repl=0);

        // wstring (Linux: utf32; Windows: utf16) -> utf8
        ZFCORE_API std::string wstring_to_utf8(const wchar_t* v, char32_t repl=0);
        ZFCORE_API std::string wstring_to_utf8(const std::wstring& v, char32_t repl=0);
