...
class ZFS_API SearchLocalMinPointMinpack
{
private:
...
public:
    ...
    int search( int (*err_func) (integer *m_ptr, integer  *n_ptr, doublereal *params, doublereal *err, integer *iflag), integer mode=1 );
};
